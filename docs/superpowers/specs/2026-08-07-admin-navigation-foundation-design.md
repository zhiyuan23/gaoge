...
> **状态：已实施并验证。** 通用导航实现提交为 `ed172ab`，当前记录对应源修订 `d9567ea0845965b08e36519129b2941dd23358d4`。

> 本文只负责布局模式、菜单投影和导航壳层。2026-08-26 之后的服务端菜单事实源、Resource 权限与受控页面注册表见 [Admin RBAC 工程底座总设计](./2026-08-26-admin-rbac-foundation-design.md)。
