  ...
  >
    <div id="app-main">
      ...
      <div class="wrapper">
        ...
        <div
          class="z-1009 op-0 invisible fixed inset-0 bg-black/50 backdrop-blur-sm transition-opacity"
          :class="{
            'op-100! visible!':
              settingsStore.mode === 'mobile' && !settingsStore.settings.menu.subMenuCollapse,
          }"
