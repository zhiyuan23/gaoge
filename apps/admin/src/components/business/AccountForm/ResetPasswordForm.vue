  ...
  <div class="min-h-500px flex-col-stretch-center w-full p-12">
    <form @submit="onSubmit">
      <div class="mb-8 space-y-2">
        <h3 class="color-[var(--el-text-color-primary)] text-4xl font-bold">忘记密码了? 🔒</h3>
      ...
      <FaButton :loading="loading" size="lg" class="mt-4 w-full" type="submit"> 确认 </FaButton>
      <div class="flex-center color-[var(--el-text-color-secondary)] mt-4 gap-2 text-sm">
