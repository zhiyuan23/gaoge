...
<template>
  <div class="bg-banner" />
  <div class="z-1 flex-center bg-background absolute right-4 top-4 rounded-lg border p-1 text-base">
    <ColorScheme v-if="settingsStore.settings.toolbar.colorScheme" />
  </div>
  <div class="login-box">
    <div class="login-banner">
      <img src="@/assets/images/logo.png" class="inset-s-4 inset-t-4 absolute h-12 rounded" />
