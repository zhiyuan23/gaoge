  ...
  <div>
    ...
    <FaPageMain title="打开新标签页">
      <div class="space-y-2">
        ...
        <FaButton @click="open"> 打开主页 </FaButton>
      </div>
    </FaPageMain>
    <FaPageMain title="关闭当前标签页并跳转">
      <div class="space-y-2">
        <p>关闭当前标签页，同时跳转到新页面。</p>
        <FaButton @click="close"> 关闭当前标签页，并跳转到主页 </FaButton>
      </div>
    </FaPageMain>
    <FaPageMain title="关闭指定标签页">
      <div class="space-y-2">
        ...
        <div class="space-x-2">
          <FaButton @click="closeById"> 关闭当前页面 </FaButton>
          <FaButton @click="closeById2"> 关闭主页 </FaButton>
        </div>
      </div>
    </FaPageMain>
