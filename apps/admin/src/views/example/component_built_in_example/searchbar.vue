...
<template>
  <div>
        ...
        <template #default="{ fold }">
          <ElForm :model="search" size="default" label-width="120px">
            ...
            <ElRow v-show="!fold">
              <ElCol :span="24">
                <ElFormItem label="角色">
                  <ElCheckbox :value="true"> 备选项 </ElCheckbox>
                  <ElCheckbox :value="false"> 备选项 </ElCheckbox>
                </ElFormItem>
              </ElCol>
            </ElRow>
            <ElFormItem>
              ...
              <ElButton type="primary" link> 查看已导出记录 </ElButton>
            </ElFormItem>
          </ElForm>
        </template>
      </FaSearchBar>
    </FaPageMain>
    <FaPageMain title="默认展开">
            ...
            <ElRow v-show="!fold">
              <ElCol :span="24">
                <ElFormItem label="复选框">
                  <ElCheckbox v-model="search.check1"> 备选项 </ElCheckbox>
                  <ElCheckbox v-model="search.check2"> 备选项 </ElCheckbox>
                </ElFormItem>
              </ElCol>
            </ElRow>
            <ElFormItem>
    ...
    <FaPageMain title="自定义切换按钮（搭配自定义 grid 布局）">
    ...
    <FaPageMain title="自定义切换按钮（搭配 el-row 组件）">
      <FaSearchBar :show-toggle="false">
        <template #default="{ fold, toggle }">
          <ElForm :model="search" size="default" label-width="120px">
            <ElRow>
