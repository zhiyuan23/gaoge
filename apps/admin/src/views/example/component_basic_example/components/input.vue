...
<template>
  <div>
    ...
    <ElDivider content-position="left"> 可清空 </ElDivider>
    <ElInput v-model="input" placeholder="请输入内容" clearable />
    <ElDivider content-position="left"> 密码框 </ElDivider>
    <ElInput v-model="input" placeholder="请输入内容" show-password />
    <ElDivider content-position="left"> 带 icon 的输入框 </ElDivider>
    ...
    <ElDivider content-position="left"> 文本域 </ElDivider>
