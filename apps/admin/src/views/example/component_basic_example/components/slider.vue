...
<template>
  <div>
    ...
    <ElDivider content-position="left"> 离散值 </ElDivider>
    <span>不显示间断点</span>
    <ElSlider v-model="value6" :step="10" />
    <span>显示间断点</span>
    <ElSlider v-model="value6" :step="10" show-stops />
    <ElDivider content-position="left"> 带有输入框 </ElDivider>
    <ElSlider v-model="value7" show-input />
    <ElDivider content-position="left"> 范围选择 </ElDivider>
    <ElSlider v-model="value8" show-stops range :max="10" />
    <ElDivider content-position="left"> 竖向模式 </ElDivider>
