<template>
  <div>
    ...
    <ElDivider content-position="left"> 文字按钮 </ElDivider>
    <ElButton text> 文字按钮 </ElButton>
    <ElButton type="primary" text> 文字按钮 </ElButton>
    <ElButton type="success" text> 文字按钮 </ElButton>
    <ElButton type="info" text> 文字按钮 </ElButton>
    <ElButton type="warning" text> 文字按钮 </ElButton>
    <ElButton type="danger" text> 文字按钮 </ElButton>
    <ElDivider content-position="left"> 图标按钮 </ElDivider>
    ...
    <ElDivider content-position="left"> 按钮组 </ElDivider>
    ...
    <ElDivider content-position="left"> 加载中 </ElDivider>
    <ElButton type="primary" :loading="true"> 加载中 </ElButton>
    <ElDivider content-position="left"> 不同尺寸 </ElDivider>
    <div style="margin-bottom: 10px">
      <ElButton size="large"> 大号按钮 </ElButton>
      <ElButton size="default"> 默认按钮 </ElButton>
      <ElButton size="small"> 小号按钮 </ElButton>
    </div>
    <div>
      <ElButton size="large" round> 大号按钮 </ElButton>
      <ElButton size="default" round> 默认按钮 </ElButton>
      <ElButton size="small" round> 小号按钮 </ElButton>
    </div>
  </div>
</template>
