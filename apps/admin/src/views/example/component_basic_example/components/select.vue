...
<template>
  <div>
    ...
    <ElDivider content-position="left"> 有禁用选项 </ElDivider>
    ...
    <ElDivider content-position="left"> 可清空单选 </ElDivider>
    ...
    <ElDivider content-position="left"> 基础多选 </ElDivider>
    ...
    <ElDivider content-position="left"> 可搜索 </ElDivider>
