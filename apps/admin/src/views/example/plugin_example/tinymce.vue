    ...
    <FaPageHeader title="TinyMCE 编辑器">
      <template #description>
        <div class="space-y-2">
          ...
          <p>
            安装成功后，在框架 /public 目录下创建 tinymce 文件夹，并将 /node_modules/tinymce
            目录下的 skins 文件夹复制到 /public/tinymce 目录下；然后在到 TinyMCE 官网
            <FaButton
              variant="link"
              class="h-auto p-0"
              href="https://www.tiny.cloud/get-tiny/language-packages/"
              target="_blank"
            >
              下载中文语言包
            </FaButton>
