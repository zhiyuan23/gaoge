  ...
  <div>
    ...
    <FaPageHeader title="G2plot">
      <template #description>
        <div class="space-y-2">
          <p>
            由于 G2 的高度可定置化，导致不同开发者开发出来的图表效果有的好看，有的不好看，G2Plot
            解决了这一问题，由官方制定了一套标准设计规范，开发者可以专注于数据，而不用关心最终呈现，当然缺点也很明显，就是自定义上不如
            G2 ，所以如果你有更复杂的需求，推荐还是使用 G2 去自行实现。
          </p>
          <p>
            安装命令：
    ...
    <div class="lg-grid-cols-2 mx-4 grid grid-cols-1 gap-4">
