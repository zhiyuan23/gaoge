  ...
  <div>
    ...
    <FaPageHeader title="VueHooks Plus">
      <template #description>
        <div class="space-y-2">
          <p>
            提供基础和高级的 hook ，高性能逻辑的抽象封装，满足大量场景，更多 API 和例子请查看
            VueHooks Plus 官网。
          </p>
          <p>
            安装命令：
    ...
    <FaPageMain title="轮询">
      <div class="space-y-2">
        ...
        <div>PollingInterval：{{ computedTime }}ms</div>
        <div class="space-x-2">
          <FaButton @click="start()"> Start </FaButton>
          <FaButton @click="update()"> time + 100ms </FaButton>
          <FaButton @click="cancel()"> Stop </FaButton>
        </div>
      </div>
    </FaPageMain>
  </div>
