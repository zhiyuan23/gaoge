import type {
  ...
  ProjectItem,
  ServiceItem,
} from '@/concepts/creator/types'

export const heroPortraitUrl =
  'https://shrug-person-78902957.figma.site/_components/v2/d24c01ad3a56fc65e942a1f501eb73db42d7cf9a/Rectangle_40443.81459862.png'

export const navigationItems = [
  { label: 'About', targetId: 'about' },
  { label: 'Price', targetId: 'services' },
...
export const marqueeTracks = {
  rowOne: [...marqueeRowOne, ...marqueeRowOne, ...marqueeRowOne],
  rowTwo: [...marqueeRowTwo, ...marqueeRowTwo, ...marqueeRowTwo],
} as const
...
] as const satisfies readonly DecorativeImage[]
