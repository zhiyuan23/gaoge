...
const getStatusLabel = (status) => (status === 'cancelled' ? '已取消' : '已确认')

const goToFootballTeam = () => {
...
<template>
  <div class="min-h-screen bg-[#090a0d] px-4 py-6 text-white md:px-8">
    <div class="mx-auto max-w-5xl">
      <button
        class="mb-6 cursor-pointer text-sm text-white/70 transition hover:text-white"
        @click="goToFootballTeam"
      >
        返回高歌FC
      </button>
